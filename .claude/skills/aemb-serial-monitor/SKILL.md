...
> **auto-embedded 工具技能**：脚本随框架装在 `.auto-embedded/tools/serial-monitor/`，用 `py` 运行 `.auto-embedded/tools/serial-monitor/scripts/` 下脚本；详细用法见 `.auto-embedded/tools/serial-monitor/references/usage.md`。
