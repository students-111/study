...
> **auto-embedded 工具技能**：脚本随框架装在 `.auto-embedded/tools/flash-jlink/`，用 `py` 运行 `.auto-embedded/tools/flash-jlink/scripts/` 下脚本；详细用法见 `.auto-embedded/tools/flash-jlink/references/usage.md`。
